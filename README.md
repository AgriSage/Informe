...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Comunica oralmente sus <br>ideas y/o resultados con objetividad a <br>público de diferentes <br>especialidades y niveles <br>jerarquicos, en el marco del <br>desarrollo de un proyecto eningeniería.     | **Luis Anampa**<br>TB1: Se ha trabajado correctamente en equipo mediante reuniones en linea , tambien nos organizamos de manera eficiente para poder repartirnos y hacer un trabajo colaborativo en grupo<br><br> TP1: Se realizaron vistas para el despliegue de la web aplication y se realizaron funcionalidades como el enrutamiento de la pagina. <br><br> TB2: Me encargue de explicar cómo el Bounded Context de Perfiles aborda problemas específicos de gestión de usuarios, aplicando principios de ingeniería y algoritmos para encontrar soluciones efectivas. <br><br> TF: Al finalizar el proyecto, consolide mis habilidades de comunicación oral al presentar de manera efectiva los resultados finales y las lecciones aprendidas demostrando mi capacidad para comunicar conclusiones técnicas con claridad y precisión.<br><br><br><br>**Diego Pumahualcca**<br> TB1: Se realizó una investigación para entender la problemática en cuestión y poder distinguir los grupos concretos a los que nos dirigimos, con el objetivo de comprender sus necesidades y ofrecerles un producto que las satisfaga.<br><br>TP1: Se llevaron a cabo revisiones para la implementación de la aplicación web y se incluyeron características como la navegación de la página.<br><br>TB2: Se realizo el Bounded Context de Tienda teniendo en cuenta la experiencia del usuario y factores económicos y sociales para mejorar la interacción y satisfacción del cliente.<br><br>TF:Con la culminación del proyecto, fortalecí mis habilidades de comunicación oral al liderar la presentación final del Bounded Context de Tienda, destacando los beneficios y mejoras logradas, y respondiendo preguntas de manera eficaz. <br><br><br><br>**Alexander Justo**<br>TB1: Se llevó a cabo un estudio con el fin de comprender la situación que estamos tratando y así poder identificar a los grupos específicos a los que nos dirigimos, para entender sus necesidades y proporcionarles un producto que las satisfaga.<br><br>TP1: Se organizaron inspecciones para el lanzamiento de la aplicación web y se incorporaron capacidades como la dirección de la página.<br><br>TB2: Se desarrollo el Bounded Context de Cursos ha sido desarrollado, enfocándose en los objetivos de aprendizaje y la estructura del contenido para proporcionar una experiencia educativa eficaz.<br><br>TF:A la conclusión del proyecto, reforcé mis habilidades de comunicación oral al liderar una sesión de preguntas y respuestas sobre el Bounded Context de Cursos, explicando claramente los desafíos y soluciones implementadas.<br><br><br><br>**Eduardo Mancilla**<br>TB1: Se hizo un análisis para poder identificar a los segmentos objetivos, y de esta manera generar soluciones innovadoras.<br><br> TP1: Se realizaron vistas para el despliegue de la web aplication y se realizaron funcionalidades como el enrutamiento de la pagina. <br><br>TB2:Se implemento el bounded context de Payments; las implicaciones éticas y de seguridad en la implementación del sistema de pagos, incluyendo la protección de datos del usuario.<br><br>TF: Al finalizar el proyecto, solidifiqué mis habilidades de comunicación oral al dirigir la presentación final sobre el Bounded Context de Payments, explicando las medidas de seguridad y las implicaciones éticas a una audiencia diversa.<br><br><br><br>**Diego Cisneros**<br>TB1: Se hizo un análisis para poder llevar a cabo este proyecto , y se colaboro activamente con todos los mienbros del equipo <br>TP1:Se efectuaron evaluaciones para la implementación de la aplicación web y se agregaron funciones como la dirección de la página.<br><br> TB2: Bounded context Carrito de Compras interactúa con otros contextos y cómo hemos optimizado su diseño para diferentes tipos de usuarios, utilizando un lenguaje comprensible para todos.<br><br> TF: Al terminar el proyecto, fortalecí mis habilidades de comunicación oral al presentar los resultados del Bounded Context Carrito de Compras, destacando las optimizaciones y mejoras realizadas para distintos tipos de usuarios.<br><br><br><br>| La comunicación oral ha sido efectiva dentro del equipo, permitiendo un intercambio fluido de ideas y una comprensión compartida de los objetivos del proyecto. Se continuará fomentando esta comunicación para mantener la colaboración y el progreso del trabajo.|
| Comunica en forma escrita ideas <br>y/o resultados con objetividad a <br>público de diferentes <br>especialidades y niveles <br>jerarquicos, en el marco del <br>desarrollo de un proyecto en ingeniería. | **Luis Anampa**<br>TB1: Se analizo las user story , las necesidades de los usuarios , hemos calificado a las user story con el product backlog, nuestra comunicacion como grupo ha sido crucial para poder terminar nuestro primer entregable<br><br> TP1 :Se organizaron evaluaciones para el despliegue de la aplicación web y se desarrollaron capacidades como la ruta de navegación dentro del sitio.<br><br> TB2:Se encargo de redactar de manera clara y objetiva la sección relacionada con el Bounded Context de Perfiles, asegurando que los detalles técnicos sean comprensibles para todos los lectores, independientemente de su especialidad.<br><br> TF: Al completar el proyecto, mejoré significativamente mis habilidades de comunicación escrita al documentar detalladamente todos los procesos y resultados, garantizando que cada sección del informe final fuera precisa y accesible para audiencias con distintos niveles de experiencia técnica. <br><br><br><br>**Diego Pumahualcca**<br>TB1:Se llevó a cabo un análisis con el propósito de comprender el contexto que estamos abordando y así poder identificar a los grupos particulares a los que nos dirigimos, con la intención de comprender sus necesidades y ofrecerles un producto que las satisfaga.<br><br>TP1: Se efectuaron análisis para el lanzamiento de la aplicación web y se implementaron funciones como la dirección de página.<br><br>TB2:He sido responsable de comunicar de forma escrita los resultados y avances del Bounded Context de Tienda, destacando su relevancia para audiencias con diversos niveles jerárquicos y áreas de especialización dentro del proyecto de ingeniería. <br><br>TF:Con la finalización del proyecto, desarrollé mis habilidades de comunicación escrita al preparar informes detallados y claros que reflejaron las metas alcanzadas y los pasos técnicos seguidos, facilitando la comprensión de todos los interesados.<br><br><br><br>**Alexander Justo**<br><br>TB1: Se elaboró un informe que abarcaba varios aspectos fundamentales para el desarrollo del proyecto, que iban desde un análisis de la problemática hasta la creación de algunos prototipos de solución.<br><br>TP1: Se llevaron a cabo inspecciones para el despliegue de la aplicación web y se introdujeron funcionalidades como el enrutado de la página.<br><br> TB2:Me encargue de redactar de manera objetiva y clara la sección correspondiente al Bounded Context de Cursos, asegurando que la información sobre los objetivos de aprendizaje y la estructura del contenido sea presentada de manera comprensible y relevante para todos los lectores, independientemente de su área de especialización dentro del proyecto de ingeniería.<br><br>TF: Al concluir el proyecto, mejoré significativamente mis habilidades de comunicación escrita al redactar detallados informes que resumían los logros y desafíos del Bounded Context de Cursos, haciendo que la información técnica fuera accesible y comprensible.<br><br> <br><br>**Eduardo Mancilla**<br>TB1: Se investigó de los principales competidores de nuestra aplicación. Además se realizaron distintos planteamientos y gráficos para tener unos segmentos objetivos principales. <br><br> TP1: Se realizaron vistas para el despliegue de la web aplication y se realizaron funcionalidades como el enrutamiento de la pagina<br><br>TB2: Me encargue de comunicar por escrito los resultados y consideraciones éticas relacionadas con el Bounded Context de Pagos, garantizando que la información sea presentada de manera comprensible y objetiva para audiencias con diversos antecedentes profesionales en el campo de la ingeniería.<br><br>TF: Al finalizar el proyecto, desarrollé aún más mis habilidades de comunicación escrita al preparar un detallado reporte del Bounded Context de Payments, asegurando la claridad y precisión en la descripción de las medidas de seguridad y consideraciones éticas.<br><br>**Diego Cisnero**<br>TB1:Se hizo un análisis para poder llevar a cabo este proyecto , y se colaboro activamente con todos los mienbros del equipo , ademas una investigacion con todos los mienbros de nuestro equipo<br><br>TP1: Se llevaron a cabo revisiones para la implementación de la aplicación web y se incorporaron características tales como la navegación entre páginas.<br><br> TB2: He redactado de manera objetiva y clara la sección correspondiente al Bounded Context de Carrito de Compras, asegurando que la información sea accesible y relevante para públicos con diferentes niveles de experiencia en ingeniería. <br><br> TF: Con la conclusión del proyecto, mejoré mis habilidades de comunicación escrita al documentar detalladamente el Bounded Context Carrito de Compras, asegurando que las descripciones técnicas fueran claras y útiles para todos los lectores. <br><br><br><br>| La comunicación escrita ha sido crucial para documentar el progreso del proyecto y asegurar la comprensión de los entregables entre los miembros del equipo. Se seguirá manteniendo un enfoque claro y conciso en la comunicación escrita para garantizar la eficacia y la calidad del trabajo. |
...
Video de las entrevistas: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202218664_upc_edu_pe/ET9DWcKBuuRBoyE7fCupUBkB0-7Jct6TxWvCEkJROrx_qQ?e=vzWszZ&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D

Realizamos 3 entrevistas dirigidas a nuestros segmentos objetivos, en las cuales
...
**- Link:** https://upcedupe-my.sharepoint.com/:v:/g/personal/u202218664_upc_edu_pe/ET9DWcKBuuRBoyE7fCupUBkB0-7Jct6TxWvCEkJROrx_qQ?e=vzWszZ&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D


**- Instante en el que inicia:** 0:05 s
...
**- Instante en el que inicia:** 6:23 min
...
**- Instante en el que inicia:** 12:25 min
